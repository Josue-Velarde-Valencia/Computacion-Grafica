...
int main()
{
	...
	*/
	...
	while (!mainWindow.getShouldClose())
	{
		...
		model = glm::rotate(model, glm::radians(mainWindow.getarticulacion1()),	glm::vec3(0.0f, 0.0f, 1.0f)); // F
		modelaux = model;
		model = glm::scale(model, glm::vec3(0.6f, 0.6f, 0.6f));
		glUniformMatrix4fv(uniformModel, 1, GL_FALSE, glm::value_ptr(model));
		color = glm::vec3(0.3f, 0.3f, 0.3f); //Gris
		glUniform3fv(uniformColor, 1, glm::value_ptr(color));
		sp.render();
		//Tubo 1 Rojo
		model = modelaux;
		...
		model = modelaux;
		model = glm::translate(model, glm::vec3(0.0f, 2.3f, 0.0f));
		model = glm::rotate(model, glm::radians(mainWindow.getarticulacion2()), glm::vec3(0.0f, 0.0f, 1.0f)); // G
		modelaux = model;
		model = glm::scale(model, glm::vec3(0.6f, 0.6f, 0.6f));
		glUniformMatrix4fv(uniformModel, 1, GL_FALSE, glm::value_ptr(model));
		...
		model = modelaux;
		model = glm::translate(model, glm::vec3(2.3f, 0.0f, 0.0f));
		model = glm::rotate(model, glm::radians(mainWindow.getarticulacion3()), glm::vec3(0.0f, 0.0f, 1.0f)); // H
		modelaux = model;
		model = glm::scale(model, glm::vec3(0.6f, 0.6f, 0.6f));
		glUniformMatrix4fv(uniformModel, 1, GL_FALSE, glm::value_ptr(model));
		color = glm::vec3(0.3f, 0.3f, 0.3f); //Gris
		...
		//Base Azul
		model = modelaux2;
		model = glm::translate(model, glm::vec3(-4.0f, 0.25f, 5.0f));
		modelaux = model;
		...
		//Tubo Amarillo
		model = modelaux;
		model = glm::translate(model, glm::vec3(-2.0f, -0.9f, 0.0f));
		modelaux = model;
		model = glm::rotate(model, glm::radians(120.0f), glm::vec3(0.0f, 0.0f, 1.0f));
		model = glm::scale(model, glm::vec3(0.5f, 4.5f, 0.8f));
		glUniformMatrix4fv(uniformModel, 1, GL_FALSE, glm::value_ptr(model));
		...
		model = glm::rotate(model, glm::radians(mainWindow.getarticulacion5()), glm::vec3(0.0f, 1.0f, 0.0f)); // K
		modelaux = model;
		...
		modelaux = model;
		model = glm::scale(model, glm::vec3(0.5f, 0.25f, 1.5f));
		glUniformMatrix4fv(uniformModel, 1, GL_FALSE, glm::value_ptr(model));
		color = glm::vec3(0.3f, 0.3f, 0.3f); //Gris
		glUniform3fv(uniformColor, 1, glm::value_ptr(color));
		meshList[0]->RenderMeshGeometry();
		//Pata Morada
		model = modelaux;
		model = glm::translate(model, glm::vec3(-0.5f, -0.4f, -0.85f));
		modelaux = model;
		model = glm::rotate(model, glm::radians(120.0f), glm::vec3(0.0f, 0.0f, 1.0f));
		model = glm::scale(model, glm::vec3(0.6f, 2.0f, 0.25f));
		glUniformMatrix4fv(uniformModel, 1, GL_FALSE, glm::value_ptr(model));
		...
		glUniform3fv(uniformColor, 1, glm::value_ptr(color));
		meshList[0]->RenderMeshGeometry();
		//Eje Soporte Rueda Gris
		model = modelaux;
		model = glm::translate(model, glm::vec3(0.2f, -0.3f, 1.1f));
		model = glm::rotate(model, glm::radians(90.0f), glm::vec3(1.0f, 0.0f, 0.0f));
		model = glm::rotate(model, glm::radians(mainWindow.getarticulacion6()), glm::vec3(0.0f, -1.0f, 0.0f)); // L
		modelaux = model;
		...
		model = glm::translate(model, glm::vec3(0.2f, -0.3f, -1.1f));
		model = glm::rotate(model, glm::radians(90.0f), glm::vec3(1.0f, 0.0f, 0.0f));
		model = glm::rotate(model, glm::radians(mainWindow.getarticulacion7()), glm::vec3(0.0f, -1.0f, 0.0f)); // P
		modelaux = model;
		model = glm::scale(model, glm::vec3(0.4f, 2.0f, 0.4f));
		glUniformMatrix4fv(uniformModel, 1, GL_FALSE, glm::value_ptr(model));
		color = glm::vec3(0.3f, 0.3f, 0.3f); // Gris
		...
		// Base Azul
		model = modelaux2;
		model = glm::translate(model, glm::vec3(0.0f, -0.25f, 4.125f));
		modelaux = model;
		...
		model = glm::rotate(model, glm::radians(mainWindow.getarticulacion8()), glm::vec3(0.0f, 0.0f, 1.0f)); // O
		modelaux = model;
		model = glm::rotate(model, glm::radians(90.0f), glm::vec3(1.0f, 0.0f, 0.0f));
		...
		model = glm::scale(model, glm::vec3(0.5f, 4.5f, 0.8f));
		glUniformMatrix4fv(uniformModel, 1, GL_FALSE, glm::value_ptr(model));
		color = glm::vec3(1.0f, 0.5f, 0.0f); //Amarillo
		glUniform3fv(uniformColor, 1, glm::value_ptr(color));
		meshList[0]->RenderMeshGeometry();
		//Eje Rueda Gris
		model = modelaux;
		model = glm::translate(model, glm::vec3(-1.3f, -1.3f, 1.6f));
		model = glm::rotate(model, glm::radians(mainWindow.getarticulacion9()), glm::vec3(0.0f, 0.0f, -1.0f)); //I
		model = glm::rotate(model, glm::radians(90.0f), glm::vec3(1.0f, 0.0f, 0.0f));
		modelaux = model;
		...
		model = modelaux;
		model = glm::translate(model, glm::vec3(-1.3f, -1.3f, -1.6f));
		model = glm::rotate(model, glm::radians(mainWindow.getarticulacion10()), glm::vec3(0.0f, 0.0f, -1.0f)); // U
		model = glm::rotate(model, glm::radians(90.0f), glm::vec3(1.0f, 0.0f, 0.0f));
		modelaux = model;
		model = glm::scale(model, glm::vec3(0.4f, 2.5f, 0.4f));
		glUniformMatrix4fv(uniformModel, 1, GL_FALSE, glm::value_ptr(model));
		...
		// Base Azul
		model = modelaux2;
		model = glm::translate(model, glm::vec3(1.5f, -0.25f, 4.125f));
		modelaux = model;
		model = glm::scale(model, glm::vec3(1.0f, 1.0f, 0.25f));
		glUniformMatrix4fv(uniformModel, 1, GL_FALSE, glm::value_ptr(model));
		color = glm::vec3(0.0f, 0.0f, 1.0f); // Azul
		...
		model = modelaux;
		model = glm::translate(model, glm::vec3(0.0f, 0.0f, 0.55f));
		model = glm::rotate(model, glm::radians(mainWindow.getarticulacion11()), glm::vec3(0.0f, 0.0f, -1.0f)); // 0
		modelaux = model;
		model = glm::rotate(model, glm::radians(90.0f), glm::vec3(1.0f, 0.0f, 0.0f));
		model = glm::scale(model, glm::vec3(0.25f, 1.0f, 0.25f));
		glUniformMatrix4fv(uniformModel, 1, GL_FALSE, glm::value_ptr(model));
		...
		model = modelaux;
		model = glm::translate(model, glm::vec3(1.3f, -1.3f, 1.6f));
		model = glm::rotate(model, glm::radians(mainWindow.getarticulacion12()), glm::vec3(0.0f, 0.0f, -1.0f)); //9
		model = glm::rotate(model, glm::radians(90.0f), glm::vec3(1.0f, 0.0f, 0.0f));
		modelaux = model;
		model = glm::scale(model, glm::vec3(0.4f, 2.5f, 0.4f));
		glUniformMatrix4fv(uniformModel, 1, GL_FALSE, glm::value_ptr(model));
		...
		model = modelaux;
		model = glm::translate(model, glm::vec3(1.3f, -1.3f, -1.6f));
		model = glm::rotate(model, glm::radians(mainWindow.getarticulacion13()), glm::vec3(0.0f, 0.0f, -1.0f)); // 8
		model = glm::rotate(model, glm::radians(90.0f), glm::vec3(1.0f, 0.0f, 0.0f));
		modelaux = model;
		model = glm::scale(model, glm::vec3(0.4f, 2.5f, 0.4f));
		glUniformMatrix4fv(uniformModel, 1, GL_FALSE, glm::value_ptr(model));
		...
		glUniformMatrix4fv(uniformProjection, 1, GL_FALSE, glm::value_ptr(projection));
		glUniformMatrix4fv(uniformView, 1, GL_FALSE, glm::value_ptr(camera.calculateViewMatrix()));
		color = glm::vec3(0.478f, 0.255f, 0.067f); //Cafe
		glUniform3fv(uniformColor, 1, glm::value_ptr(color));
		meshList[0]->RenderMesh();
		...
		model = modelaux2;
		model = modelaux;
		model = glm::translate(model, glm::vec3(0.0f, 2.5f, 2.75f));
		...
		model = glm::rotate(model, glm::radians(-90.0f), glm::vec3(1.0f, 0.0f, 0.0f));
		model = glm::scale(model, glm::vec3(1.5f, 0.6f, 1.5f));
		glUniformMatrix4fv(uniformModel, 1, GL_FALSE, glm::value_ptr(model));
		color = glm::vec3(0.6f, 0.6f, 0.6f); //Gris
		glUniform3fv(uniformColor, 1, glm::value_ptr(color));
		...
		modelaux = model;
		model = modelaux;
		model = glm::scale(model, glm::vec3(25.0f, 1.0f, 0.5f));
		glUniformMatrix4fv(uniformModel, 1, GL_FALSE, glm::value_ptr(model));
		color = glm::vec3(0.6f, 0.6f, 0.6f); //Gris
		glUniform3fv(uniformColor, 1, glm::value_ptr(color));
		meshList[0]->RenderMeshGeometry();
		//Paneles Azules
		model = modelaux; //Primero
		model = glm::translate(model, glm::vec3(12.5f, -0.2f, 0.35f));
		modelaux = model;
		model = glm::scale(model, glm::vec3(4.5f, 8.0f, 0.2f));
		glUniformMatrix4fv(uniformModel, 1, GL_FALSE, glm::value_ptr(model));
		color = glm::vec3(0.0f, 0.0f, 0.8f); // Azul
		glUniform3fv(uniformColor, 1, glm::value_ptr(color));
		meshList[0]->RenderMeshGeometry();
		model = modelaux; //Segundo
		...
		modelaux = model;
		model = modelaux;
		model = glm::rotate(model, glm::radians(1020.0f), glm::vec3(1.0f, 0.0f, 0.0f));
		...
		model = glm::scale(model, glm::vec3(1.8f, 3.0f, 1.8f));
		glUniformMatrix4fv(uniformModel, 1, GL_FALSE, glm::value_ptr(model));
		color = glm::vec3(0.5f, 0.8f, 1.0f); //Azul Claro
		glUniform3fv(uniformColor, 1, glm::value_ptr(color));
