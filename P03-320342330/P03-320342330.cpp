...
int main()
{
	...
	*/
	...
	while (!mainWindow.getShouldClose())
	{
		...
		// Cono azul
		model = baseModel;
		model = glm::translate(model, glm::vec3(0.6f, 0.9f, 0.0f));
		model = glm::scale(model, glm::vec3(0.125f, 0.3f, 0.125f));
		glUniformMatrix4fv(uniformModel, 1, GL_FALSE, glm::value_ptr(model));
		glUniformMatrix4fv(uniformProjection, 1, GL_FALSE, glm::value_ptr(projection));
		glUniformMatrix4fv(uniformView, 1, GL_FALSE, glm::value_ptr(camera.calculateViewMatrix()));
		color = glm::vec3(0.0f, 0.0f, 1.0f); // Azul
		...
		// Pirámide triangular roja
		model = baseModel;
		model = glm::translate(model, glm::vec3(-0.3f, -0.5f, 0.3f));
		model = glm::scale(model, glm::vec3(0.2f, 0.6f, 0.2f));
		model = glm::rotate(model, -220.0f * toRadians, glm::vec3(0.0f, 1.0f, 0.0f));
		glUniformMatrix4fv(uniformModel, 1, GL_FALSE, glm::value_ptr(model));
		glUniformMatrix4fv(uniformProjection, 1, GL_FALSE, glm::value_ptr(projection));
		glUniformMatrix4fv(uniformView, 1, GL_FALSE, glm::value_ptr(camera.calculateViewMatrix()));
		color = glm::vec3(1.0f, 0.0f, 0.0f); // Rojo
		...
		model = glm::translate(model, glm::vec3(-0.3f, -0.5f, -0.3f));
		model = glm::scale(model, glm::vec3(0.2f, 0.6f, 0.2f));
		model = glm::rotate(model, 300.0f * toRadians, glm::vec3(0.0f, 1.0f, 0.0f));
		glUniformMatrix4fv(uniformModel, 1, GL_FALSE, glm::value_ptr(model));
		glUniformMatrix4fv(uniformProjection, 1, GL_FALSE, glm::value_ptr(projection));
		glUniformMatrix4fv(uniformView, 1, GL_FALSE, glm::value_ptr(camera.calculateViewMatrix()));
		color = glm::vec3(1.0f, 0.0f, 0.0f); // Rojo
		...
		glUniformMatrix4fv(uniformProjection, 1, GL_FALSE, glm::value_ptr(projection));
		glUniformMatrix4fv(uniformView, 1, GL_FALSE, glm::value_ptr(camera.calculateViewMatrix()));
		color = glm::vec3(0.3f, 0.3f, 0.3f); // Azul
		glUniform3fv(uniformColor, 1, glm::value_ptr(color));
		...
		// Cono gris
		model = baseModel;
		model = glm::translate(model, glm::vec3(-0.6f, -0.78f, 0.0f));
		model = glm::scale(model, glm::vec3(0.12f, 0.03f, 0.12f));
		glUniformMatrix4fv(uniformModel, 1, GL_FALSE, glm::value_ptr(model));
		glUniformMatrix4fv(uniformProjection, 1, GL_FALSE, glm::value_ptr(projection));
		glUniformMatrix4fv(uniformView, 1, GL_FALSE, glm::value_ptr(camera.calculateViewMatrix()));
		color = glm::vec3(0.3f, 0.3f, 0.3f); // Azul
		...
		// Cono azul
		model = baseModel;
		model = glm::translate(model, glm::vec3(0.0f, 0.9f, 0.4f));
		model = glm::rotate(model, 90.0f * toRadians, glm::vec3(1.0f, 0.0f, 0.0f));
		model = glm::scale(model, glm::vec3(0.08f, 0.01f, 0.08f));
		glUniformMatrix4fv(uniformModel, 1, GL_FALSE, glm::value_ptr(model));
		glUniformMatrix4fv(uniformProjection, 1, GL_FALSE, glm::value_ptr(projection));
		glUniformMatrix4fv(uniformView, 1, GL_FALSE, glm::value_ptr(camera.calculateViewMatrix()));
		...
		glUniform3fv(uniformColor, 1, glm::value_ptr(color));
		meshList[3]->RenderMeshGeometry();
		// Piramide cuadrangular amarillo
		model = baseModel;
		...
		// Piramide cuadrangular amarillo
		model = baseModel;
		model = glm::translate(model, glm::vec3(-0.6f, -0.95f, 0.0f));
		model = glm::rotate(model, 180.0f * toRadians, glm::vec3(1.0f, 0.0f, 0.0f));
		...
		*/
		...
		// Magenta
		model = baseModel;
		model = glm::translate(model, glm::vec3(0.0f, 0.91f, 0.0f));
		...
		// Verde
		model = baseModel;
		model = glm::translate(model, glm::vec3(0.0f, -0.61f, 0.0f));
		model = glm::scale(model, glm::vec3(1.0f, 0.5f, 1.0f));
		model = glm::rotate(model, 180.0f * toRadians, glm::vec3(1.0f, 0.0f, 0.0f));
		glUniformMatrix4fv(uniformModel, 1, GL_FALSE, glm::value_ptr(model));
		glUniformMatrix4fv(uniformProjection, 1, GL_FALSE, glm::value_ptr(projection));
		...
		// Amarillo
		model = baseModel;
		model = glm::translate(model, glm::vec3(0.751f, 0.15f, 0.0f));
		...
		// Azul
		model = baseModel;
		model = glm::translate(model, glm::vec3(0.25f, 0.15f, 0.0f));
		model = glm::scale(model, glm::vec3(0.5f, 1.0f, 1.0f));
		model = glm::rotate(model, 90.0f * toRadians, glm::vec3(0.0f, 0.0f, 1.0f));
		glUniformMatrix4fv(uniformModel, 1, GL_FALSE, glm::value_ptr(model));
		glUniformMatrix4fv(uniformProjection, 1, GL_FALSE, glm::value_ptr(projection));
		...
		// Rojo
		model = baseModel;
		model = glm::translate(model, glm::vec3(-0.76f, 0.15f, 0.0f));
		model = glm::scale(model, glm::vec3(0.5f, 1.0f, 1.0f));
		model = glm::rotate(model, 90.0f * toRadians, glm::vec3(0.0f, 0.0f, 1.0f));
		glUniformMatrix4fv(uniformModel, 1, GL_FALSE, glm::value_ptr(model));
		glUniformMatrix4fv(uniformProjection, 1, GL_FALSE, glm::value_ptr(projection));
